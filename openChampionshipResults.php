<?php
	...
	$sqlOpenChamp = require('sql/viewOpenChamp.php');
	
	// Get the Open Championship Race Times
	if(mysqli_multi_query($conn,$sqlOpenChamp))
	{
		do{
			if($result=mysqli_store_result($conn)){
				while($row=mysqli_fetch_assoc($result)){
	...
	$sqlOpenChampRaces = require('sql/viewOpenChampRaces.php');
	
	// Get the Open Championship Races
	if(mysqli_multi_query($conn,$sqlOpenChampRaces))
	{
		do{
			if($result=mysqli_store_result($conn)){
				while($row=mysqli_fetch_assoc($result)){
