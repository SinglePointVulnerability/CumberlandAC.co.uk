    ...
    <script>
        ...
        function loadImage() {
			...
			document.getElementById('imageSelectContainer').innerHTML = '<input type="file" name="runleader_image" accept="image/*"><br>' +
				'<input type="hidden" name="form_url" value="updateTrainingRunLeader_UpdateRunLeader.php">' +
				'Delete my photo <input type="checkbox" id="delete_photo" name="delete_photo" value="1"><br>' +
